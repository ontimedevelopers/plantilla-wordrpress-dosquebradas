		...
		function wp_dosquebradas_setup()
		{
			...
			{  
				...
				if(1 != $pages)
				{
			    	...
			    	echo '<span class="sr-only">Navegación de páginas</span>';
			    	...
			    	echo '<li class="page-item disabled hidden-md-down d-none d-lg-block"><span class="page-link">Página '.$paged.' de '.$pages.'</span></li>';
				 	...
				 	if($paged > 2 && $paged > $range+1 && $showitems < $pages) 
						echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link(1).'" aria-label="Primera página"><span class="hidden-sm-down d-none d-md-block">&laquo; Primera</span></a></li>';
				
				 	if($paged > 1 && $showitems < $pages) 
						echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($paged - 1).'" aria-label="Anterior Página"><span class="hidden-sm-down d-none d-md-block">&lsaquo;  Anterior</span></a></li>';
				
					for ($i=1; $i <= $pages; $i++)
					{
				    if (1 != $pages &&( !($i >= $paged+$range+1 || $i <= $paged-$range-1) || $pages <= $showitems ))
						echo ($paged == $i)? '<li class="page-item active"><span class="page-link"><span class="sr-only">Actual página </span>'.$i.'</span></li>' : '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($i).'"><span class="sr-only">Página </span>'.$i.'</a></li>';
					}
					
					if ($paged < $pages && $showitems < $pages) 
						echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($paged + 1).'" aria-label="Siguiente página"><span class="hidden-sm-down d-none d-md-block">Siguiente &rsaquo;</span></a></li>';  
				
				 	if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) 
						echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($pages).'" aria-label="Última página"><span class="hidden-sm-down d-none d-md-block">Última &raquo;</span></a></li>';
				
				 	echo '</ul>';
			    	echo '</nav>';
			    	// echo '<div class="pagination-info mb-5 text-center">[ <span class="text-muted">Página</span> '.$paged.' <span class="text-muted">de</span> '.$pages.' ]</div>';	 	
				}
			}
